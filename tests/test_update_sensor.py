"""Unit tests for the PlacesUpdater class and related functionality in the custom_components.places.update_sensor module.

This module contains pytest-based asynchronous tests for update logic, attribute handling, event firing, and integration with Home Assistant mocks.
"""
