...
@pytest.mark.asyncio
async def test_build_from_advanced_options_not_none_calls_normal(monkeypatch, sensor):
...
@pytest.mark.asyncio
async def test_build_from_advanced_options_processed_options(monkeypatch, sensor):
...
@pytest.mark.asyncio
async def test_build_from_advanced_options_no_bracket_or_paren(monkeypatch, sensor):
...
@pytest.mark.asyncio
async def test_build_from_advanced_options_with_comma(monkeypatch, sensor):
...
@pytest.mark.asyncio
async def test_build_from_advanced_options_no_comma(monkeypatch, sensor):
