...
async def test_async_setup_entry_places_param(
    ...
    with stub_method(hass, "async_add_executor_job", side_effect=lambda func, *a: func(*a)):
...
async def test_async_will_remove_from_hass_param(
    ...
    cm_async_add = stub_method(
        places_instance._hass, "async_add_executor_job", side_effect=lambda func, *args: func(*args)
    )
    with cm_async_add:
