...
This module contains unit and integration tests for the Places sensor component,
verifying attribute handling, update logic, event exclusion, and Home Assistant entity lifecycle.
"""
...
def test_get_attr_safe_float_list(places_instance):
    """Test that get_attr_safe_float returns 0.0 when the attribute value is a list."""
