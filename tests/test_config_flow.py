"""Tests for the Places integration config flow.

This module contains unit and integration tests for the config flow, options flow,
and validation logic of the custom_components.places integration.
"""
