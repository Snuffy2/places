...
- Using pre-commit hooks with settings in `/.pre-commit-config.yaml`.
- Use Ruff for code style consistency with settings in `/pyproject.toml`.
- Use mypy for static type checking with settings in `/pyproject.toml`.
